...
class UserService:
    ...
    def register(event_args_dict):
        ...
        """
        try:
            new_user_address, signed_address = itemgetter("user", "signedAddress")(
                event_args_dict
            )
            ...
            smartContractService.service.report_registration_to_sc(
                new_user_address, auth_status
            )
        except Exception as e:
            log.info(f"register error {e}")
            # SC callback called with success as False
            smartContractService.service.report_registration_to_sc(
                new_user_address, False
            )
    ...
    def unregister(event_args_dict):
        ...
        try:
            ...
            smartContractService.service.report_unregistration_to_sc(
                user_address, user_len > 0
            )
